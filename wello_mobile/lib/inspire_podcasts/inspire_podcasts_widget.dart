...
class InspirePodcastsWidget extends StatefulWidget {
  const InspirePodcastsWidget({Key key}) : super(key: key);

  @override
  _InspirePodcastsWidgetState createState() => _InspirePodcastsWidgetState();
}

class _InspirePodcastsWidgetState extends State<InspirePodcastsWidget> {
              ...
              child: Container(
                ...
                child: StreamBuilder<List<PodcastsRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<PodcastsRecord> columnPodcastsRecordList =
                        snapshot.data;
                    return SingleChildScrollView(
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: List.generate(columnPodcastsRecordList.length,
                            (columnIndex) {
                          final columnPodcastsRecord =
                              columnPodcastsRecordList[columnIndex];
                          return Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    columnPodcastsRecord.description,
                                    textAlign: TextAlign.center,
