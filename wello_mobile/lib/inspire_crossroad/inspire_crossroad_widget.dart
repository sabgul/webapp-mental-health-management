...
import '../inspire_podcasts/inspire_podcasts_widget.dart';
...
class InspireCrossroadWidget extends StatefulWidget {
  const InspireCrossroadWidget({Key key}) : super(key: key);

  @override
  _InspireCrossroadWidgetState createState() => _InspireCrossroadWidgetState();
}

class _InspireCrossroadWidgetState extends State<InspireCrossroadWidget> {
                          ...
                          Container(
                            ...
                            child: StreamBuilder<List<CitationsRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<CitationsRecord>
                                    columnCitationsRecordList = snapshot.data;
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => InspirePodcastsWidget(),
                              ),
                            );
                          },
                          text: 'Zobraziť podcasty\n',
