                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Dajte si pauzu'),
                                        content: Text(
                                            'Je čas si trocha vydýchnuť. Na chvíľu sa uvoľnite a nerozmýšľajte nad povinnosťami. Odporúčame Vám aktivitu uvedomelého dýchania.'),
                                        actions: [
                                          TextButton(
                                ...
                                text:
                                    'Nastaviť upozornenie, že je čas spomaliť',
                                options: FFButtonOptions(
                                  width: 130,
                                  height: 40,
                                  color: Color(0xFFF4EBE8),
