...
import '../new_emotion_record/new_emotion_record_widget.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class EmotionsWidget extends StatefulWidget {
  const EmotionsWidget({Key key}) : super(key: key);

  @override
  _EmotionsWidgetState createState() => _EmotionsWidgetState();
}
          ...
          children: [
            ...
            Container(
              ...
              child: AuthUserStreamWidget(
                child: StreamBuilder<List<EmotionJournalEntriesRecord>>(
                  stream: queryEmotionJournalEntriesRecord(
                    queryBuilder: (emotionJournalEntriesRecord) =>
                        emotionJournalEntriesRecord
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<EmotionJournalEntriesRecord>
                        columnEmotionJournalEntriesRecordList = snapshot.data;
                    return SingleChildScrollView(
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: List.generate(
                            columnEmotionJournalEntriesRecordList.length,
                            (columnIndex) {
                          final columnEmotionJournalEntriesRecord =
                              columnEmotionJournalEntriesRecordList[
                                  columnIndex];
                          return Padding(
                            padding:
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0, 10, 0, 0),
                                          child: Text(
                                            columnEmotionJournalEntriesRecord
                                                .emotion,
                                            textAlign: TextAlign.center,
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          5, 0, 0, 0),
                                      child: Text(
                                        columnEmotionJournalEntriesRecord.text,
                                        style: FlutterFlowTheme.bodyText1,
                                      ),
                                    ),
                                  )
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => NewEmotionRecordWidget(),
                      ),
                    );
                  },
                  text: 'Nový zápisok',
