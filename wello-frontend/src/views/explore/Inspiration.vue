...
<v-sheet>
 <v-slide-group v-model="model" class="temp" center-active show-arrows >
     <v-slide-item v-slot:default="{ active, toggle }">
         <v-card max-width="200" @click="toggle"
            elevation="8"
            outlined class="mr-5">
        <v-img  height="200px" :src="require('@/assets/undraw_handcrafts_tree.svg')"></v-img>
        <v-card-title class="black--text align-end" style="word-break: break-word;">
            Survival story
        </v-card-title>
            <v-card-subtitle class="pb-0">Anonymous</v-card-subtitle>
...
<v-dialog
    ...
    >
        ...
        >
          ...
          <v-toolbar-title>Survival story</v-toolbar-title>
          <v-spacer></v-spacer>
        </v-toolbar> 
