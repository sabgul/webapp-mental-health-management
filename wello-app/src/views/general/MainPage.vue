  ...
  <div class="unscrollable">
    <v-container justify-center>
                ...
                <v-list-item class="grow">
                  <v-btn class="ma-2" text icon>
                    <v-icon
                      class="mr-1"
                      x-large
                      @click="ratingClicked(1)"
                    >mdi-emoticon-frown-outline</v-icon>
                  </v-btn>

                  <v-btn class="ma-2" text icon>
                    <v-icon class="mr-1" x-large @click="ratingClicked(2)">mdi-emoticon-sad-outline</v-icon>
                  </v-btn>
      ...
      <v-layout row justify="center" justify-space-between>
        <v-flex xs12>
          <v-card class="ma-3" elevation="8" outlined color="#3DAF7B" dark min-width="75%">
            <v-textarea
...
export default {
  ...
  methods: {
    ...
    reasonClicked() {
      ...
      this.record.feelingReason = document.getElementById(
        "feelingTextArea"
      ).value;
